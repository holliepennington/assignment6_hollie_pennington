...
There is a significant association between political party and identifying as an environmentalist ($\chi$^2^(`r x2_pol_tidy$parameter`) = `r x2_pol_tidy$statistic`, *p* = `r x2_pol_tidy$p.value`). 
